...
format_reason_msg(allowing_rule) = msg {
	...
	msg := sprintf(
		...
		[input.request.metadata.userInfo.username, userset, resourceset, userset, input.request.metadata.operation, input.request.kind.kind, resourceset],
...
format_reason_msg(allowing_rule) = msg {
	...
	msg := sprintf(
		...
		[input.request.metadata.userInfo.username, role, "default", resourceset, role, input.request.metadata.operation, input.request.kind.kind, resourceset],
...
format_reason_msg(allowing_rule) = msg {
	...
	msg := sprintf(
		...
		[input.request.metadata.userInfo.username, userset, userset, input.request.metadata.operation, input.request.kind.kind],
